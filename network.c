...
#pragma GCC diagnostic ignored "-Wunused-result"
    ...
    if (args.is_v17_tcp_bypass || args.is_v18_tcp || args.is_v18_tls) {
        ...
        // 2. Bypass conntrack — saves massive CPU, prevents conntrack table overflow
